...
public class TunnelCrateObstacle : MonoBehaviour
{
    ...
    private void FixMaterialsInRuntime(GameObject obj)
    {
        ...
        // Koyu ahşap renginde yepyeni, sağlam URP materyal yarat (Eskiyi çöpe at)
        Material woodMat = new Material(urpLit);
        woodMat.color = new Color(0.35f, 0.22f, 0.12f, 1f); // Ahşap kahvesi
        woodMat.SetFloat("_Smoothness", 0.05f); // Parlamaz, mat
